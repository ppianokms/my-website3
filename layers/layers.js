...
lyr_ESRIWorldTopo_0.setVisible(true);lyr_pl_amphoe_1.setVisible(true);lyr_pl_tambon_2.setVisible(true);lyr_pl_stream_3.setVisible(true);lyr_pl_transportation_4.setVisible(true);lyr_pl_village_5.setVisible(true);
var layersList = [lyr_ESRIWorldTopo_0,lyr_pl_amphoe_1,lyr_pl_tambon_2,lyr_pl_stream_3,lyr_pl_transportation_4,lyr_pl_village_5];
...
lyr_pl_amphoe_1.set('fieldImages', {'AREA': '', 'AMP_CODE': '', 'AMP_NAM_T': '', 'AMP_NAM_E': '', 'PROV_CODE': '', });
